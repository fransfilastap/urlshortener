...
func (m *MockURLService) CreateShortURL(ctx context.Context, originalURL string, customShort string, title string, expireAfter time.Duration, creatorReference string) (*domain.URL, error) {
...
func (m *MockURLService) GetByShort(ctx context.Context, short string) (*domain.URL, error) {
...
func (m *MockURLService) GetByOriginal(ctx context.Context, original string) (*domain.URL, error) {
...
func (m *MockURLService) GetClicksByShort(ctx context.Context, short string) ([]*domain.Click, error) {
	args := m.Called(ctx, short)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockURLService) UpdateURL(ctx context.Context, short string, title, originalURL string, expireAfter time.Duration) (*domain.URL, error) {
...
func (m *MockURLService) DeleteWithCreator(ctx context.Context, short string, creatorReference string) error {
	args := m.Called(ctx, short, creatorReference)
	return args.Error(0)
}

func (m *MockURLService) GetByCreator(ctx context.Context, creatorReference string) ([]*domain.URL, error) {
...
func (m *MockURLService) UpdateURLWithCreator(ctx context.Context, short string, title, originalURL string, expireAfter time.Duration, creatorReference string) (*domain.URL, error) {
	args := m.Called(ctx, short, title, originalURL, expireAfter, creatorReference)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*domain.URL), args.Error(1)
...
func TestShortenURL(t *testing.T) {
	...
	t.Run("InvalidURL", func(t *testing.T) {
		...
		mockService.On("CreateShortURL", mock.Anything, "invalid-url", "custom", "", time.Duration(0), "").Return(nil, domain.ErrInvalidURL)
